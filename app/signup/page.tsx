...
export default function SignupPage() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setIsLoading(false)
    console.log("[v0] Signup attempted with:", formData)
  }
      ...
      >
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-card-foreground/70 font-sans">
            Join NetScout to discover network devices instantly
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          <form onSubmit={handleSignup} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="firstName" className="text-sm font-medium text-card-foreground font-sans">
                  First Name
                </Label>
                <Input
                  id="firstName"
              ...
              <div className="space-y-2">
                <Label htmlFor="lastName" className="text-sm font-medium text-card-foreground font-sans">
                  Last Name
                </Label>
                <Input
                  id="lastName"
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="terms" className="text-sm text-card-foreground/70 font-sans">
                I agree to the{" "}
          ...
          <div className="space-y-3">
            <Button
              ...
              className="w-full glass-effect border-white/30 hover-lift ripple-effect text-card-foreground hover:bg-white/20 hover:text-gray-800 font-sans transition-all duration-300"
            >
