      ...
      >
        <CardHeader className="text-center space-y-2">
          ...
          <CardDescription className="text-card-foreground/70 font-sans">
            {searchQuery ? (
              <>
                Sign in to search for "<span className="font-semibold text-primary">{searchQuery}</span>" and access our device catalog
              </>
            ) : (
              "Sign in to your NetScout account to continue"
            )}
          </CardDescription>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="text-center">
            <p className="text-sm text-card-foreground/70 font-sans mb-3">
